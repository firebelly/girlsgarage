  ...
  <div class="one-half -right grid">
    ...
    <?php if (!empty(\Firebelly\SiteOptions\get_option('scholarship_application_form'))): ?>
      <div class="one-half card -white -cut-right -wide">
        <div class="-inner">
          <h3>Scholarships</h3>
          <p>Because every girl who wants to attend should be able to. Download our scholarship application.</p>
          <a href="<?= \Firebelly\SiteOptions\get_option('scholarship_application_form'); ?>" target="_blank" class="btn">More</a>
        </div>
      </div>
    <?php endif; ?>
